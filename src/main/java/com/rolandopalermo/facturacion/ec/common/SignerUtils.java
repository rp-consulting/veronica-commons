        ...
        try {
            ...
            while (e.hasMoreElements()) {
                ...
                if (SignerUtils.hasCertificatePolicies(c)) {
                    expirationDate = DateUtils.convertToLocalDateTimeViaInstant(c.getNotAfter());
                    break;
                }
            }
            temp.delete();
            ...
            throw new VeronicaException("No se pudo leer la fecha de expiración del certificado digital");
        }
    }
